...
WORKING_DIRECTORY         (idx, [1:134])  = '/home/gridley/salt-management-DMSR/data/DMSR-lattice/ct4m/dflibe/fs0.225/p34.0/nochemistry/mtpointertest/test2/test2/anotherone/asdf20' ;
...
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  1.00477E+00  9.94314E-01  9.95052E-01  1.00357E+00  9.96703E-01  1.00341E+00  1.00345E+00  9.98728E-01  ];
...
TOT_CPU_TIME              (idx, 1)        =  9.22774E+01 ;
RUNNING_TIME              (idx, 1)        =  1.20703E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  5.65883E-01  5.65883E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  1.71667E-02  1.71667E-02 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  1.14868E+01  1.14868E+01  0.00000E+00 ];
BURNUP_CYCLE_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
BATEMAN_SOLUTION_TIME     (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  1.20698E+01  0.00000E+00 ];
CPU_USAGE                 (idx, 1)        = 7.64501 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98703E+00 5.1E-05 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  9.50319E-01 ;
...
CPU_MHZ                   (idx, 1)        = 18.0 ;
START_DATE                (idx, [1: 24])  = 'Tue Nov 22 15:26:31 2016' ;
COMPLETE_DATE             (idx, [1: 24])  = 'Tue Nov 22 15:50:10 2016' ;
...
MPI_REPRODUCIBILITY       (idx, 1)        = 0 ;
OMP_REPRODUCIBILITY       (idx, 1)        = 1 ;
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  1.00512E+00  1.00408E+00  9.94362E-01  9.97262E-01  1.00424E+00  1.00638E+00  9.93024E-01  9.95534E-01  ];
SHARE_BUF_ARRAY           (idx, 1)        = 0 ;
SHARE_RES2_ARRAY          (idx, 1)        = 1 ;
...
TOT_CPU_TIME              (idx, 1)        =  1.84149E+02 ;
RUNNING_TIME              (idx, 1)        =  2.36559E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  5.65883E-01  5.65883E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  3.47167E-02  1.75500E-02 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  2.29709E+01  1.14841E+01  0.00000E+00 ];
BURNUP_CYCLE_TIME         (idx, [1:  2])  = [  8.37500E-02  8.37500E-02 ];
BATEMAN_SOLUTION_TIME     (idx, [1:  2])  = [  1.94167E-02  1.94167E-02 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  2.36557E+01  2.36557E+01 ];
CPU_USAGE                 (idx, 1)        = 7.78449 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98775E+00 2.3E-05 ];
