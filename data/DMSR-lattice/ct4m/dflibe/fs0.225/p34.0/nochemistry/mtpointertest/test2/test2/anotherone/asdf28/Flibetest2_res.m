...
WORKING_DIRECTORY         (idx, [1:134])  = '/home/gridley/salt-management-DMSR/data/DMSR-lattice/ct4m/dflibe/fs0.225/p34.0/nochemistry/mtpointertest/test2/test2/anotherone/asdf28' ;
HOSTNAME                  (idx, [1:  6])  = 'node44' ;
CPU_TYPE                  (idx, [1: 39])  = 'Intel(R) Core(TM) i7-4770 CPU @ 3.40GHz' ;
CPU_MHZ                   (idx, 1)        = 9.0 ;
START_DATE                (idx, [1: 24])  = 'Tue Nov 22 15:49:33 2016' ;
COMPLETE_DATE             (idx, [1: 24])  = 'Tue Nov 22 16:01:30 2016' ;
...
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  1.00704E+00  1.00408E+00  9.95982E-01  1.00501E+00  9.98787E-01  1.00095E+00  9.92964E-01  9.95186E-01  ];
...
TOT_CPU_TIME              (idx, 1)        =  9.19539E+01 ;
RUNNING_TIME              (idx, 1)        =  1.19476E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  4.84983E-01  4.84983E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  1.50667E-02  1.50667E-02 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  1.14472E+01  1.14472E+01  0.00000E+00 ];
BURNUP_CYCLE_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
BATEMAN_SOLUTION_TIME     (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  1.19471E+01  0.00000E+00 ];
CPU_USAGE                 (idx, 1)        = 7.69643 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98803E+00 4.9E-05 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  9.56580E-01 ;
...
MPI_REPRODUCIBILITY       (idx, 1)        = 0 ;
OMP_REPRODUCIBILITY       (idx, 1)        = 1 ;
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  9.97622E-01  1.00526E+00  9.96367E-01  9.96443E-01  1.00161E+00  1.00264E+00  1.00504E+00  9.95013E-01  ];
SHARE_BUF_ARRAY           (idx, 1)        = 0 ;
SHARE_RES2_ARRAY          (idx, 1)        = 1 ;
...
RUNNING_TIME              (idx, 1)        =  2.34936E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  4.84983E-01  4.84983E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  2.98333E-02  1.47667E-02 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  2.28948E+01  1.14476E+01  0.00000E+00 ];
BURNUP_CYCLE_TIME         (idx, [1:  2])  = [  8.33500E-02  8.33500E-02 ];
BATEMAN_SOLUTION_TIME     (idx, [1:  2])  = [  1.86333E-02  1.86333E-02 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  2.34929E+01  2.34929E+01 ];
CPU_USAGE                 (idx, 1)        = 7.81096 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98778E+00 6.8E-05 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  9.76450E-01 ;
