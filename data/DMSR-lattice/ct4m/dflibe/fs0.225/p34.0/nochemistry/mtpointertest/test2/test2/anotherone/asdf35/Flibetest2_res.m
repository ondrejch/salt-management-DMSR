...
WORKING_DIRECTORY         (idx, [1:134])  = '/home/gridley/salt-management-DMSR/data/DMSR-lattice/ct4m/dflibe/fs0.225/p34.0/nochemistry/mtpointertest/test2/test2/anotherone/asdf35' ;
HOSTNAME                  (idx, [1:  6])  = 'node43' ;
CPU_TYPE                  (idx, [1: 39])  = 'Intel(R) Core(TM) i7-4770 CPU @ 3.40GHz' ;
CPU_MHZ                   (idx, 1)        = 9.0 ;
START_DATE                (idx, [1: 24])  = 'Tue Nov 22 15:50:04 2016' ;
COMPLETE_DATE             (idx, [1: 24])  = 'Tue Nov 22 16:01:47 2016' ;
...
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  1.00030E+00  9.97435E-01  9.89070E-01  1.00791E+00  1.00755E+00  1.00923E+00  9.98040E-01  9.90463E-01  ];
...
TOT_CPU_TIME              (idx, 1)        =  9.01211E+01 ;
RUNNING_TIME              (idx, 1)        =  1.17186E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  4.86583E-01  4.86583E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  1.49500E-02  1.49500E-02 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  1.12166E+01  1.12166E+01  0.00000E+00 ];
BURNUP_CYCLE_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
BATEMAN_SOLUTION_TIME     (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  1.17180E+01  0.00000E+00 ];
CPU_USAGE                 (idx, 1)        = 7.69040 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98855E+00 4.9E-05 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  9.55579E-01 ;
...
CPU_MHZ                   (idx, 1)        = 9.0 ;
START_DATE                (idx, [1: 24])  = 'Tue Nov 22 15:50:04 2016' ;
COMPLETE_DATE             (idx, [1: 24])  = 'Tue Nov 22 16:13:06 2016' ;
...
MPI_REPRODUCIBILITY       (idx, 1)        = 0 ;
OMP_REPRODUCIBILITY       (idx, 1)        = 1 ;
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  1.01256E+00  1.00082E+00  9.83859E-01  1.00011E+00  1.00608E+00  9.98290E-01  9.96746E-01  1.00154E+00  ];
SHARE_BUF_ARRAY           (idx, 1)        = 0 ;
SHARE_RES2_ARRAY          (idx, 1)        = 1 ;
...
TOT_CPU_TIME              (idx, 1)        =  1.79854E+02 ;
RUNNING_TIME              (idx, 1)        =  2.30333E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  4.86583E-01  4.86583E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  2.94000E-02  1.44500E-02 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  2.24334E+01  1.12168E+01  0.00000E+00 ];
BURNUP_CYCLE_TIME         (idx, [1:  2])  = [  8.30333E-02  8.30333E-02 ];
BATEMAN_SOLUTION_TIME     (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  2.30331E+01  2.30331E+01 ];
CPU_USAGE                 (idx, 1)        = 7.80845 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98802E+00 6.0E-05 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  9.75954E-01 ;
