...
WORKING_DIRECTORY         (idx, [1:133])  = '/home/gridley/salt-management-DMSR/data/DMSR-lattice/ct4m/dflibe/fs0.225/p34.0/nochemistry/mtpointertest/test2/test2/anotherone/asdf4' ;
HOSTNAME                  (idx, [1:  6])  = 'node49' ;
CPU_TYPE                  (idx, [1: 39])  = 'Intel(R) Core(TM) i7-4790 CPU @ 3.60GHz' ;
CPU_MHZ                   (idx, 1)        = 32.0 ;
START_DATE                (idx, [1: 24])  = 'Tue Nov 22 15:26:29 2016' ;
...
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  1.01781E+00  9.95100E-01  9.74443E-01  1.00991E+00  9.74892E-01  1.00284E+00  1.01535E+00  1.00966E+00  ];
...
TOT_CPU_TIME              (idx, 1)        =  9.09270E+01 ;
RUNNING_TIME              (idx, 1)        =  1.18032E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  4.70033E-01  4.70033E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  1.49500E-02  1.49500E-02 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  1.13179E+01  1.13179E+01  0.00000E+00 ];
BURNUP_CYCLE_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
BATEMAN_SOLUTION_TIME     (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  1.18028E+01  0.00000E+00 ];
CPU_USAGE                 (idx, 1)        = 7.70356 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98916E+00 7.8E-05 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  9.57514E-01 ;
...
MPI_REPRODUCIBILITY       (idx, 1)        = 0 ;
OMP_REPRODUCIBILITY       (idx, 1)        = 1 ;
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  9.99859E-01  9.97635E-01  9.80212E-01  1.01385E+00  1.00096E+00  1.00875E+00  1.01141E+00  9.87313E-01  ];
SHARE_BUF_ARRAY           (idx, 1)        = 0 ;
SHARE_RES2_ARRAY          (idx, 1)        = 1 ;
...
TOT_CPU_TIME              (idx, 1)        =  1.81346E+02 ;
RUNNING_TIME              (idx, 1)        =  2.31998E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  4.70033E-01  4.70033E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  2.96667E-02  1.47167E-02 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  2.26188E+01  1.13010E+01  0.00000E+00 ];
BURNUP_CYCLE_TIME         (idx, [1:  2])  = [  8.07833E-02  8.07833E-02 ];
BATEMAN_SOLUTION_TIME     (idx, [1:  2])  = [  1.79833E-02  1.79833E-02 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  2.31997E+01  2.31997E+01 ];
CPU_USAGE                 (idx, 1)        = 7.81669 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98974E+00 5.7E-05 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  9.77042E-01 ;
