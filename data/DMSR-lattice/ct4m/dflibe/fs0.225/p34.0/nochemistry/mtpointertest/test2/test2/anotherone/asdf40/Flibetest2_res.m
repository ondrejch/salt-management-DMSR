...
WORKING_DIRECTORY         (idx, [1:134])  = '/home/gridley/salt-management-DMSR/data/DMSR-lattice/ct4m/dflibe/fs0.225/p34.0/nochemistry/mtpointertest/test2/test2/anotherone/asdf40' ;
HOSTNAME                  (idx, [1:  6])  = 'node40' ;
CPU_TYPE                  (idx, [1: 39])  = 'Intel(R) Core(TM) i7-4770 CPU @ 3.40GHz' ;
CPU_MHZ                   (idx, 1)        = 9.0 ;
START_DATE                (idx, [1: 24])  = 'Tue Nov 22 15:50:17 2016' ;
COMPLETE_DATE             (idx, [1: 24])  = 'Tue Nov 22 16:02:02 2016' ;
...
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  1.00782E+00  1.00600E+00  1.00912E+00  9.73387E-01  9.99636E-01  1.00045E+00  9.87713E-01  1.01588E+00  ];
...
TOT_CPU_TIME              (idx, 1)        =  9.03531E+01 ;
RUNNING_TIME              (idx, 1)        =  1.17607E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  5.00817E-01  5.00817E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  1.47667E-02  1.47667E-02 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  1.12448E+01  1.12448E+01  0.00000E+00 ];
BURNUP_CYCLE_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
BATEMAN_SOLUTION_TIME     (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  1.17602E+01  0.00000E+00 ];
CPU_USAGE                 (idx, 1)        = 7.68262 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98802E+00 5.6E-05 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  9.54518E-01 ;
...
CPU_MHZ                   (idx, 1)        = 9.0 ;
START_DATE                (idx, [1: 24])  = 'Tue Nov 22 15:50:17 2016' ;
COMPLETE_DATE             (idx, [1: 24])  = 'Tue Nov 22 16:13:23 2016' ;
...
MPI_REPRODUCIBILITY       (idx, 1)        = 0 ;
OMP_REPRODUCIBILITY       (idx, 1)        = 1 ;
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  1.00015E+00  9.96662E-01  1.01169E+00  9.83675E-01  9.99223E-01  1.00259E+00  9.98530E-01  1.00749E+00  ];
SHARE_BUF_ARRAY           (idx, 1)        = 0 ;
SHARE_RES2_ARRAY          (idx, 1)        = 1 ;
...
TOT_CPU_TIME              (idx, 1)        =  1.80298E+02 ;
RUNNING_TIME              (idx, 1)        =  2.31018E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  5.00817E-01  5.00817E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  2.95000E-02  1.47333E-02 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  2.24875E+01  1.12427E+01  0.00000E+00 ];
BURNUP_CYCLE_TIME         (idx, [1:  2])  = [  8.33833E-02  8.33833E-02 ];
BATEMAN_SOLUTION_TIME     (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  2.31016E+01  2.31016E+01 ];
CPU_USAGE                 (idx, 1)        = 7.80449 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98831E+00 4.9E-05 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  9.75412E-01 ;
