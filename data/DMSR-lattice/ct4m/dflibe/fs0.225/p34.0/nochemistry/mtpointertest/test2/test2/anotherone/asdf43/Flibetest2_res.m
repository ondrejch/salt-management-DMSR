...
WORKING_DIRECTORY         (idx, [1:134])  = '/home/gridley/salt-management-DMSR/data/DMSR-lattice/ct4m/dflibe/fs0.225/p34.0/nochemistry/mtpointertest/test2/test2/anotherone/asdf43' ;
HOSTNAME                  (idx, [1:  6])  = 'node48' ;
CPU_TYPE                  (idx, [1: 39])  = 'Intel(R) Core(TM) i7-4790 CPU @ 3.60GHz' ;
CPU_MHZ                   (idx, 1)        = 32.0 ;
START_DATE                (idx, [1: 24])  = 'Tue Nov 22 16:11:34 2016' ;
COMPLETE_DATE             (idx, [1: 24])  = 'Tue Nov 22 16:23:14 2016' ;
...
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  9.99676E-01  1.00264E+00  9.93380E-01  1.00334E+00  1.00888E+00  1.00374E+00  9.95158E-01  9.93184E-01  ];
...
TOT_CPU_TIME              (idx, 1)        =  8.98020E+01 ;
RUNNING_TIME              (idx, 1)        =  1.16668E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  4.68867E-01  4.68867E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  1.49000E-02  1.49000E-02 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  1.11827E+01  1.11827E+01  0.00000E+00 ];
BURNUP_CYCLE_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
BATEMAN_SOLUTION_TIME     (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  1.16663E+01  0.00000E+00 ];
CPU_USAGE                 (idx, 1)        = 7.69726 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98484E+00 6.2E-05 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  9.56607E-01 ;
...
CPU_MHZ                   (idx, 1)        = 32.0 ;
START_DATE                (idx, [1: 24])  = 'Tue Nov 22 16:11:34 2016' ;
COMPLETE_DATE             (idx, [1: 24])  = 'Tue Nov 22 16:34:30 2016' ;
...
MPI_REPRODUCIBILITY       (idx, 1)        = 0 ;
OMP_REPRODUCIBILITY       (idx, 1)        = 1 ;
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  9.98484E-01  1.00318E+00  9.92547E-01  1.00083E+00  1.00952E+00  1.00478E+00  9.94016E-01  9.96643E-01  ];
SHARE_BUF_ARRAY           (idx, 1)        = 0 ;
SHARE_RES2_ARRAY          (idx, 1)        = 1 ;
...
TOT_CPU_TIME              (idx, 1)        =  1.79212E+02 ;
RUNNING_TIME              (idx, 1)        =  2.29430E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  4.68867E-01  4.68867E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  2.97333E-02  1.48333E-02 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  2.23629E+01  1.11802E+01  0.00000E+00 ];
BURNUP_CYCLE_TIME         (idx, [1:  2])  = [  8.10667E-02  8.10667E-02 ];
BATEMAN_SOLUTION_TIME     (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  2.29429E+01  2.29429E+01 ];
CPU_USAGE                 (idx, 1)        = 7.81118 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98584E+00 4.7E-05 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  9.76387E-01 ;
