...
WORKING_DIRECTORY         (idx, [1:134])  = '/home/gridley/salt-management-DMSR/data/DMSR-lattice/ct4m/dflibe/fs0.225/p34.0/nochemistry/mtpointertest/test2/test2/anotherone/asdf48' ;
HOSTNAME                  (idx, [1:  5])  = 'node2' ;
CPU_TYPE                  (idx, [1: 39])  = 'Intel(R) Core(TM) i7-4770 CPU @ 3.40GHz' ;
CPU_MHZ                   (idx, 1)        = 9.0 ;
START_DATE                (idx, [1: 24])  = 'Tue Nov 22 16:12:32 2016' ;
COMPLETE_DATE             (idx, [1: 24])  = 'Tue Nov 22 16:24:17 2016' ;
...
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  9.88310E-01  1.00117E+00  1.00429E+00  1.00203E+00  1.00691E+00  1.00010E+00  1.00157E+00  9.95617E-01  ];
...
TOT_CPU_TIME              (idx, 1)        =  9.03725E+01 ;
RUNNING_TIME              (idx, 1)        =  1.17582E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  4.94617E-01  4.94617E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  1.50000E-02  1.50000E-02 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  1.12482E+01  1.12482E+01  0.00000E+00 ];
BURNUP_CYCLE_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
BATEMAN_SOLUTION_TIME     (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  1.17577E+01  0.00000E+00 ];
CPU_USAGE                 (idx, 1)        = 7.68595 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98754E+00 9.3E-05 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  9.54949E-01 ;
...
CPU_MHZ                   (idx, 1)        = 9.0 ;
START_DATE                (idx, [1: 24])  = 'Tue Nov 22 16:12:32 2016' ;
COMPLETE_DATE             (idx, [1: 24])  = 'Tue Nov 22 16:35:38 2016' ;
...
MPI_REPRODUCIBILITY       (idx, 1)        = 0 ;
OMP_REPRODUCIBILITY       (idx, 1)        = 1 ;
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  9.90534E-01  9.97011E-01  1.00285E+00  1.00443E+00  1.00495E+00  9.98915E-01  1.00428E+00  9.97035E-01  ];
SHARE_BUF_ARRAY           (idx, 1)        = 0 ;
SHARE_RES2_ARRAY          (idx, 1)        = 1 ;
...
TOT_CPU_TIME              (idx, 1)        =  1.80348E+02 ;
RUNNING_TIME              (idx, 1)        =  2.31044E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  4.94617E-01  4.94617E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  3.01667E-02  1.51667E-02 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  2.24958E+01  1.12476E+01  0.00000E+00 ];
BURNUP_CYCLE_TIME         (idx, [1:  2])  = [  8.31333E-02  8.31333E-02 ];
BATEMAN_SOLUTION_TIME     (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  2.31042E+01  2.31042E+01 ];
CPU_USAGE                 (idx, 1)        = 7.80581 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98767E+00 6.3E-05 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  9.75608E-01 ;
