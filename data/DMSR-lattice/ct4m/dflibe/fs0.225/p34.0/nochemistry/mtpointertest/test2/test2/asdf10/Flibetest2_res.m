...
WORKING_DIRECTORY         (idx, [1:123])  = '/home/gridley/salt-management-DMSR/data/DMSR-lattice/ct4m/dflibe/fs0.225/p34.0/nochemistry/mtpointertest/test2/test2/asdf10' ;
HOSTNAME                  (idx, [1:  6])  = 'node56' ;
CPU_TYPE                  (idx, [1: 39])  = 'Intel(R) Core(TM) i7-4790 CPU @ 3.60GHz' ;
CPU_MHZ                   (idx, 1)        = 32.0 ;
START_DATE                (idx, [1: 24])  = 'Sun Nov 20 16:07:45 2016' ;
COMPLETE_DATE             (idx, [1: 24])  = 'Sun Nov 20 16:19:10 2016' ;
...
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  1.00900E+00  9.96049E-01  9.94260E-01  9.99817E-01  1.00555E+00  1.00518E+00  9.90290E-01  9.99848E-01  ];
...
TOT_CPU_TIME              (idx, 1)        =  8.78782E+01 ;
RUNNING_TIME              (idx, 1)        =  1.14268E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  4.70400E-01  4.70400E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  1.51333E-02  1.51333E-02 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  1.09409E+01  1.09409E+01  0.00000E+00 ];
BURNUP_CYCLE_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
BATEMAN_SOLUTION_TIME     (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  1.14263E+01  0.00000E+00 ];
CPU_USAGE                 (idx, 1)        = 7.69057 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98564E+00 6.2E-05 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  9.55913E-01 ;
...
CPU_MHZ                   (idx, 1)        = 32.0 ;
START_DATE                (idx, [1: 24])  = 'Sun Nov 20 16:07:45 2016' ;
COMPLETE_DATE             (idx, [1: 24])  = 'Sun Nov 20 16:30:13 2016' ;
...
MPI_REPRODUCIBILITY       (idx, 1)        = 0 ;
OMP_REPRODUCIBILITY       (idx, 1)        = 1 ;
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  1.00579E+00  1.00561E+00  1.00341E+00  9.93947E-01  1.00456E+00  9.97842E-01  9.94900E-01  9.93939E-01  ];
SHARE_BUF_ARRAY           (idx, 1)        = 0 ;
SHARE_RES2_ARRAY          (idx, 1)        = 1 ;
...
TOT_CPU_TIME              (idx, 1)        =  1.75425E+02 ;
RUNNING_TIME              (idx, 1)        =  2.24670E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  4.70400E-01  4.70400E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  2.97667E-02  1.46333E-02 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  2.18856E+01  1.09447E+01  0.00000E+00 ];
BURNUP_CYCLE_TIME         (idx, [1:  2])  = [  8.07667E-02  8.07667E-02 ];
BATEMAN_SOLUTION_TIME     (idx, [1:  2])  = [  1.81000E-02  1.81000E-02 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  2.24669E+01  2.24669E+01 ];
CPU_USAGE                 (idx, 1)        = 7.80810 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98698E+00 2.2E-05 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  9.76122E-01 ;
