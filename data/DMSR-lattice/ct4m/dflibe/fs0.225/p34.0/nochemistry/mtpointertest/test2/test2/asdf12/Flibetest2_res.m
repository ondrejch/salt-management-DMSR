...
WORKING_DIRECTORY         (idx, [1:123])  = '/home/gridley/salt-management-DMSR/data/DMSR-lattice/ct4m/dflibe/fs0.225/p34.0/nochemistry/mtpointertest/test2/test2/asdf12' ;
HOSTNAME                  (idx, [1:  6])  = 'node53' ;
CPU_TYPE                  (idx, [1: 39])  = 'Intel(R) Core(TM) i7-4790 CPU @ 3.60GHz' ;
CPU_MHZ                   (idx, 1)        = 32.0 ;
START_DATE                (idx, [1: 24])  = 'Sun Nov 20 16:07:45 2016' ;
COMPLETE_DATE             (idx, [1: 24])  = 'Sun Nov 20 16:19:32 2016' ;
...
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  9.64125E-01  1.01015E+00  1.00653E+00  1.01086E+00  9.93497E-01  9.87309E-01  1.01085E+00  1.01668E+00  ];
...
TOT_CPU_TIME              (idx, 1)        =  9.08256E+01 ;
RUNNING_TIME              (idx, 1)        =  1.17917E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  4.68517E-01  4.68517E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  1.44667E-02  1.44667E-02 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  1.13083E+01  1.13083E+01  0.00000E+00 ];
BURNUP_CYCLE_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
BATEMAN_SOLUTION_TIME     (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  1.17912E+01  0.00000E+00 ];
CPU_USAGE                 (idx, 1)        = 7.70251 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98663E+00 5.0E-05 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  9.57388E-01 ;
...
CPU_MHZ                   (idx, 1)        = 32.0 ;
START_DATE                (idx, [1: 24])  = 'Sun Nov 20 16:07:45 2016' ;
COMPLETE_DATE             (idx, [1: 24])  = 'Sun Nov 20 16:30:55 2016' ;
...
MPI_REPRODUCIBILITY       (idx, 1)        = 0 ;
OMP_REPRODUCIBILITY       (idx, 1)        = 1 ;
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  9.72965E-01  1.01627E+00  1.00728E+00  9.97564E-01  1.00752E+00  1.01073E+00  9.71179E-01  1.01649E+00  ];
SHARE_BUF_ARRAY           (idx, 1)        = 0 ;
SHARE_RES2_ARRAY          (idx, 1)        = 1 ;
...
TOT_CPU_TIME              (idx, 1)        =  1.81044E+02 ;
RUNNING_TIME              (idx, 1)        =  2.31681E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  4.68517E-01  4.68517E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  2.91333E-02  1.46667E-02 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  2.25892E+01  1.12809E+01  0.00000E+00 ];
BURNUP_CYCLE_TIME         (idx, [1:  2])  = [  8.07000E-02  8.07000E-02 ];
BATEMAN_SOLUTION_TIME     (idx, [1:  2])  = [  1.79667E-02  1.79667E-02 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  2.31680E+01  2.31680E+01 ];
CPU_USAGE                 (idx, 1)        = 7.81435 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98572E+00 5.7E-05 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  9.76768E-01 ;
