...
WORKING_DIRECTORY         (idx, [1:123])  = '/home/gridley/salt-management-DMSR/data/DMSR-lattice/ct4m/dflibe/fs0.225/p34.0/nochemistry/mtpointertest/test2/test2/asdf17' ;
...
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  1.00795E+00  1.00162E+00  9.99733E-01  9.99425E-01  9.99123E-01  1.00425E+00  9.92146E-01  9.95747E-01  ];
...
TOT_CPU_TIME              (idx, 1)        =  9.04722E+01 ;
RUNNING_TIME              (idx, 1)        =  1.21105E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  8.74200E-01  8.74200E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  2.12167E-02  2.12167E-02 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  1.12151E+01  1.12151E+01  0.00000E+00 ];
BURNUP_CYCLE_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
BATEMAN_SOLUTION_TIME     (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  1.21103E+01  0.00000E+00 ];
CPU_USAGE                 (idx, 1)        = 7.47054 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98883E+00 4.9E-05 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  9.25206E-01 ;
...
CPU_MHZ                   (idx, 1)        = 9.0 ;
START_DATE                (idx, [1: 24])  = 'Sun Nov 20 16:07:45 2016' ;
COMPLETE_DATE             (idx, [1: 24])  = 'Sun Nov 20 16:31:11 2016' ;
...
MPI_REPRODUCIBILITY       (idx, 1)        = 0 ;
OMP_REPRODUCIBILITY       (idx, 1)        = 1 ;
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  1.00139E+00  1.00575E+00  1.00430E+00  1.00054E+00  1.00089E+00  9.96559E-01  9.94733E-01  9.95838E-01  ];
SHARE_BUF_ARRAY           (idx, 1)        = 0 ;
SHARE_RES2_ARRAY          (idx, 1)        = 1 ;
...
TOT_CPU_TIME              (idx, 1)        =  1.80217E+02 ;
RUNNING_TIME              (idx, 1)        =  2.34299E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  8.74200E-01  8.74200E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  3.57500E-02  1.45333E-02 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  2.24365E+01  1.12215E+01  0.00000E+00 ];
BURNUP_CYCLE_TIME         (idx, [1:  2])  = [  8.31500E-02  8.31500E-02 ];
BATEMAN_SOLUTION_TIME     (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  2.34298E+01  2.34298E+01 ];
CPU_USAGE                 (idx, 1)        = 7.69173 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98762E+00 9.4E-05 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  9.60001E-01 ;
