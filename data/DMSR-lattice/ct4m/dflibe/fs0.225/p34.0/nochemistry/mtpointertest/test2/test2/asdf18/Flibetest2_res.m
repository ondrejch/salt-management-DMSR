...
WORKING_DIRECTORY         (idx, [1:123])  = '/home/gridley/salt-management-DMSR/data/DMSR-lattice/ct4m/dflibe/fs0.225/p34.0/nochemistry/mtpointertest/test2/test2/asdf18' ;
HOSTNAME                  (idx, [1:  6])  = 'node39' ;
CPU_TYPE                  (idx, [1: 39])  = 'Intel(R) Core(TM) i7-4770 CPU @ 3.40GHz' ;
CPU_MHZ                   (idx, 1)        = 9.0 ;
START_DATE                (idx, [1: 24])  = 'Sun Nov 20 16:07:46 2016' ;
COMPLETE_DATE             (idx, [1: 24])  = 'Sun Nov 20 16:19:56 2016' ;
...
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  1.00471E+00  1.00356E+00  9.91819E-01  1.00484E+00  9.96378E-01  1.00244E+00  9.98227E-01  9.98034E-01  ];
...
TOT_CPU_TIME              (idx, 1)        =  9.03216E+01 ;
RUNNING_TIME              (idx, 1)        =  1.21831E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  9.53733E-01  9.53733E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  1.91833E-02  1.91833E-02 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  1.12102E+01  1.12102E+01  0.00000E+00 ];
BURNUP_CYCLE_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
BATEMAN_SOLUTION_TIME     (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  1.21829E+01  0.00000E+00 ];
CPU_USAGE                 (idx, 1)        = 7.41367 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98501E+00 6.5E-05 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  9.18592E-01 ;

% Memory usage:

AVAIL_MEM                 (idx, 1)        = 32054.86 ;
ALLOC_MEMSIZE             (idx, 1)        = 9790.65;
MEMSIZE                   (idx, 1)        = 9164.24;
XS_MEMSIZE                (idx, 1)        = 8944.70;
MAT_MEMSIZE               (idx, 1)        = 148.62;
RES_MEMSIZE               (idx, 1)        = 0.35;
MISC_MEMSIZE              (idx, 1)        = 70.57;
UNKNOWN_MEMSIZE           (idx, 1)        = 0.00;
UNUSED_MEMSIZE            (idx, 1)        = 626.41;
...
CPU_MHZ                   (idx, 1)        = 9.0 ;
START_DATE                (idx, [1: 24])  = 'Sun Nov 20 16:07:46 2016' ;
COMPLETE_DATE             (idx, [1: 24])  = 'Sun Nov 20 16:31:14 2016' ;
...
MPI_REPRODUCIBILITY       (idx, 1)        = 0 ;
OMP_REPRODUCIBILITY       (idx, 1)        = 1 ;
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  1.01118E+00  1.00426E+00  9.96982E-01  9.97478E-01  9.96330E-01  9.97119E-01  9.94293E-01  1.00236E+00  ];
SHARE_BUF_ARRAY           (idx, 1)        = 0 ;
SHARE_RES2_ARRAY          (idx, 1)        = 1 ;
...
TOT_CPU_TIME              (idx, 1)        =  1.79900E+02 ;
RUNNING_TIME              (idx, 1)        =  2.34823E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  9.53733E-01  9.53733E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  3.41667E-02  1.49833E-02 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  2.24109E+01  1.12007E+01  0.00000E+00 ];
BURNUP_CYCLE_TIME         (idx, [1:  2])  = [  8.32667E-02  8.32667E-02 ];
BATEMAN_SOLUTION_TIME     (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  2.34821E+01  2.34821E+01 ];
CPU_USAGE                 (idx, 1)        = 7.66111 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98590E+00 6.8E-05 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  9.56236E-01 ;
