...
WORKING_DIRECTORY         (idx, [1:123])  = '/home/gridley/salt-management-DMSR/data/DMSR-lattice/ct4m/dflibe/fs0.225/p34.0/nochemistry/mtpointertest/test2/test2/asdf19' ;
HOSTNAME                  (idx, [1:  6])  = 'node36' ;
CPU_TYPE                  (idx, [1: 39])  = 'Intel(R) Core(TM) i7-4770 CPU @ 3.40GHz' ;
CPU_MHZ                   (idx, 1)        = 18.0 ;
START_DATE                (idx, [1: 24])  = 'Sun Nov 20 16:07:46 2016' ;
COMPLETE_DATE             (idx, [1: 24])  = 'Sun Nov 20 16:19:52 2016' ;
...
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  1.00732E+00  9.89126E-01  1.00097E+00  9.95221E-01  1.00417E+00  1.00367E+00  9.99252E-01  1.00026E+00  ];
...
TOT_CPU_TIME              (idx, 1)        =  9.32116E+01 ;
RUNNING_TIME              (idx, 1)        =  1.21066E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  4.87683E-01  4.87683E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  1.68500E-02  1.68500E-02 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  1.16017E+01  1.16017E+01  0.00000E+00 ];
BURNUP_CYCLE_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
BATEMAN_SOLUTION_TIME     (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  1.21061E+01  0.00000E+00 ];
CPU_USAGE                 (idx, 1)        = 7.69924 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98821E+00 5.9E-05 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  9.57062E-01 ;
...
MPI_REPRODUCIBILITY       (idx, 1)        = 0 ;
OMP_REPRODUCIBILITY       (idx, 1)        = 1 ;
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  1.00914E+00  9.89342E-01  1.00096E+00  9.97247E-01  1.00642E+00  9.98507E-01  1.00021E+00  9.98175E-01  ];
SHARE_BUF_ARRAY           (idx, 1)        = 0 ;
SHARE_RES2_ARRAY          (idx, 1)        = 1 ;
...
TOT_CPU_TIME              (idx, 1)        =  1.85839E+02 ;
RUNNING_TIME              (idx, 1)        =  2.37840E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  4.87683E-01  4.87683E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  3.38000E-02  1.69500E-02 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  2.31787E+01  1.15770E+01  0.00000E+00 ];
BURNUP_CYCLE_TIME         (idx, [1:  2])  = [  8.33333E-02  8.33333E-02 ];
BATEMAN_SOLUTION_TIME     (idx, [1:  2])  = [  1.88667E-02  1.88667E-02 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  2.37839E+01  2.37839E+01 ];
CPU_USAGE                 (idx, 1)        = 7.81358 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98902E+00 4.8E-05 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  9.76807E-01 ;
