...
WORKING_DIRECTORY         (idx, [1:122])  = '/home/gridley/salt-management-DMSR/data/DMSR-lattice/ct4m/dflibe/fs0.225/p34.0/nochemistry/mtpointertest/test2/test2/asdf5' ;
HOSTNAME                  (idx, [1:  6])  = 'node45' ;
CPU_TYPE                  (idx, [1: 39])  = 'Intel(R) Core(TM) i7-4770 CPU @ 3.40GHz' ;
CPU_MHZ                   (idx, 1)        = 9.0 ;
START_DATE                (idx, [1: 24])  = 'Sun Nov 20 16:05:43 2016' ;
COMPLETE_DATE             (idx, [1: 24])  = 'Sun Nov 20 16:17:29 2016' ;
...
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  1.01166E+00  9.90697E-01  1.00088E+00  9.80276E-01  1.00929E+00  1.00488E+00  9.98348E-01  1.00396E+00  ];
...
TOT_CPU_TIME              (idx, 1)        =  9.05319E+01 ;
RUNNING_TIME              (idx, 1)        =  1.17695E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  4.88800E-01  4.88800E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  1.44000E-02  1.44000E-02 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  1.12659E+01  1.12659E+01  0.00000E+00 ];
BURNUP_CYCLE_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
BATEMAN_SOLUTION_TIME     (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  1.17690E+01  0.00000E+00 ];
CPU_USAGE                 (idx, 1)        = 7.69208 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98971E+00 5.1E-05 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  9.55832E-01 ;
...
CPU_MHZ                   (idx, 1)        = 9.0 ;
START_DATE                (idx, [1: 24])  = 'Sun Nov 20 16:05:43 2016' ;
COMPLETE_DATE             (idx, [1: 24])  = 'Sun Nov 20 16:28:51 2016' ;
...
MPI_REPRODUCIBILITY       (idx, 1)        = 0 ;
OMP_REPRODUCIBILITY       (idx, 1)        = 1 ;
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  1.01195E+00  1.00942E+00  1.00034E+00  9.80213E-01  9.92340E-01  1.00400E+00  9.97262E-01  1.00448E+00  ];
SHARE_BUF_ARRAY           (idx, 1)        = 0 ;
SHARE_RES2_ARRAY          (idx, 1)        = 1 ;
...
RUNNING_TIME              (idx, 1)        =  2.31391E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  4.88800E-01  4.88800E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  2.92000E-02  1.48000E-02 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  2.25373E+01  1.12713E+01  0.00000E+00 ];
BURNUP_CYCLE_TIME         (idx, [1:  2])  = [  8.32167E-02  8.32167E-02 ];
BATEMAN_SOLUTION_TIME     (idx, [1:  2])  = [  1.84500E-02  1.84500E-02 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  2.31389E+01  2.31389E+01 ];
CPU_USAGE                 (idx, 1)        = 7.80994 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98978E+00 6.9E-05 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  9.76198E-01 ;
