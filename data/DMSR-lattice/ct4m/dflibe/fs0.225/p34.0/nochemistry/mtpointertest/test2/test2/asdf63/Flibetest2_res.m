...
WORKING_DIRECTORY         (idx, [1:123])  = '/home/gridley/salt-management-DMSR/data/DMSR-lattice/ct4m/dflibe/fs0.225/p34.0/nochemistry/mtpointertest/test2/test2/asdf63' ;
HOSTNAME                  (idx, [1:  6])  = 'node42' ;
CPU_TYPE                  (idx, [1: 39])  = 'Intel(R) Core(TM) i7-4770 CPU @ 3.40GHz' ;
CPU_MHZ                   (idx, 1)        = 32.0 ;
START_DATE                (idx, [1: 24])  = 'Sun Nov 20 16:31:18 2016' ;
COMPLETE_DATE             (idx, [1: 24])  = 'Sun Nov 20 16:43:01 2016' ;
...
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  1.00151E+00  1.01124E+00  9.93851E-01  1.00284E+00  9.92708E-01  1.00273E+00  1.00115E+00  9.93966E-01  ];
...
TOT_CPU_TIME              (idx, 1)        =  9.01767E+01 ;
RUNNING_TIME              (idx, 1)        =  1.17145E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  4.78233E-01  4.78233E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  1.44167E-02  1.44167E-02 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  1.12219E+01  1.12219E+01  0.00000E+00 ];
BURNUP_CYCLE_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
BATEMAN_SOLUTION_TIME     (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  1.17144E+01  0.00000E+00 ];
CPU_USAGE                 (idx, 1)        = 7.69783 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98991E+00 3.2E-05 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  9.56565E-01 ;
...
CPU_MHZ                   (idx, 1)        = 32.0 ;
START_DATE                (idx, [1: 24])  = 'Sun Nov 20 16:31:18 2016' ;
COMPLETE_DATE             (idx, [1: 24])  = 'Sun Nov 20 16:54:20 2016' ;
...
MPI_REPRODUCIBILITY       (idx, 1)        = 0 ;
OMP_REPRODUCIBILITY       (idx, 1)        = 1 ;
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  1.00019E+00  1.01013E+00  9.93483E-01  9.98218E-01  9.95492E-01  1.00293E+00  1.00015E+00  9.99409E-01  ];
SHARE_BUF_ARRAY           (idx, 1)        = 0 ;
SHARE_RES2_ARRAY          (idx, 1)        = 1 ;
...
TOT_CPU_TIME              (idx, 1)        =  1.80005E+02 ;
RUNNING_TIME              (idx, 1)        =  2.30391E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  4.78233E-01  4.78233E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  2.88500E-02  1.44333E-02 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  2.24489E+01  1.12270E+01  0.00000E+00 ];
BURNUP_CYCLE_TIME         (idx, [1:  2])  = [  8.29167E-02  8.29167E-02 ];
BATEMAN_SOLUTION_TIME     (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  2.30390E+01  2.30390E+01 ];
CPU_USAGE                 (idx, 1)        = 7.81302 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98973E+00 4.5E-05 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  9.76606E-01 ;
