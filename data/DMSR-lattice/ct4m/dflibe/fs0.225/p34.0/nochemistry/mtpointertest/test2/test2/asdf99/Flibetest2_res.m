...
WORKING_DIRECTORY         (idx, [1:123])  = '/home/gridley/salt-management-DMSR/data/DMSR-lattice/ct4m/dflibe/fs0.225/p34.0/nochemistry/mtpointertest/test2/test2/asdf99' ;
HOSTNAME                  (idx, [1:  6])  = 'node14' ;
CPU_TYPE                  (idx, [1: 39])  = 'Intel(R) Core(TM) i7-4790 CPU @ 3.60GHz' ;
CPU_MHZ                   (idx, 1)        = 32.0 ;
START_DATE                (idx, [1: 24])  = 'Sun Nov 20 16:52:46 2016' ;
COMPLETE_DATE             (idx, [1: 24])  = 'Sun Nov 20 17:04:16 2016' ;
...
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  1.00865E+00  1.00108E+00  9.98756E-01  9.91316E-01  1.00383E+00  1.00134E+00  9.92038E-01  1.00298E+00  ];
...
TOT_CPU_TIME              (idx, 1)        =  8.84015E+01 ;
RUNNING_TIME              (idx, 1)        =  1.15063E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  4.90967E-01  4.90967E-01 ];
...
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  1.15058E+01  0.00000E+00 ];
CPU_USAGE                 (idx, 1)        = 7.68291 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98808E+00 4.1E-05 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  9.54409E-01 ;
...
CPU_MHZ                   (idx, 1)        = 32.0 ;
START_DATE                (idx, [1: 24])  = 'Sun Nov 20 16:52:46 2016' ;
COMPLETE_DATE             (idx, [1: 24])  = 'Sun Nov 20 17:15:22 2016' ;
...
MPI_REPRODUCIBILITY       (idx, 1)        = 0 ;
OMP_REPRODUCIBILITY       (idx, 1)        = 1 ;
OMP_HISTORY_PROFILE       (idx, [1:   8]) = [  1.00649E+00  1.00259E+00  9.97959E-01  9.96194E-01  1.00085E+00  1.00343E+00  9.98830E-01  9.93657E-01  ];
SHARE_BUF_ARRAY           (idx, 1)        = 0 ;
SHARE_RES2_ARRAY          (idx, 1)        = 1 ;
...
TOT_CPU_TIME              (idx, 1)        =  1.76406E+02 ;
RUNNING_TIME              (idx, 1)        =  2.26020E+01 ;
INIT_TIME                 (idx, [1:  2])  = [  4.90967E-01  4.90967E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  2.88000E-02  1.42667E-02 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  2.20009E+01  1.10005E+01  0.00000E+00 ];
BURNUP_CYCLE_TIME         (idx, [1:  2])  = [  8.07833E-02  8.07833E-02 ];
BATEMAN_SOLUTION_TIME     (idx, [1:  2])  = [  1.79667E-02  1.79667E-02 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  2.26019E+01  2.26019E+01 ];
CPU_USAGE                 (idx, 1)        = 7.80491 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  7.98858E+00 2.3E-05 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  9.75327E-01 ;
