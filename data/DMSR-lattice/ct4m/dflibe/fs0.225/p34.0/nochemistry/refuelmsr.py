...
inputfile=SerpentInputFile(core_size="4m", salt_type="dflibe", case=1, salt_fraction=0.225, pitch=34.0, initial_enrichment=.012097, num_nodes=10, PPN=8, queue='gen5', pmem=None) #this calls the core writer perl script, and reads in material and geometry data
