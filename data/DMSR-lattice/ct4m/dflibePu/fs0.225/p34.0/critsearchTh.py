...
def main(argv):
    ...
    name1='1th{}flibepuga'.format(thoriumfrac)
    name2='2th{}flibepuga'.format(thoriumfrac)
    ...
    fuel1noTh=mix(pugaf, flibe, pufrcs[0]) #fuel for first input file
    fuel2noTh=mix(pugaf, flibe, pufrcs[1])
